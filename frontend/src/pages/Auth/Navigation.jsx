...
const Navigation = () => {
  ...
  const logoutHandler = async()=>{
    ...
    return  (   
    <div style={{zIndex:999}} className={`${showSiderbar ? "hidden":"flex"}xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed` } id="navigation-container">
